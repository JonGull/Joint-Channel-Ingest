...
offline_chat_df = _sql_access_utils.get_query_as_dataframe(query=f'select * from dbo.view_chat_data_general_offline_aggregated' ,database='liveengage_chat_data')
offline_chat_df.chat_date = pd.to_datetime(offline_chat_df.chat_date).dt.date
...
for day in calendar_df.RetVal:
    ...
    for index, row in lca_lookup.iterrows():
        ...
        offline_chat_dict = chat_data_lookup(offline_chat_df, lca, day.date())
        ...
        "no_of_inbound_within_office_hours_short_duration_calls":inbound_within_office_hours_short_duration_calls,
        "no_of_inbound_within_office_hours_long_duration_calls":inbound_within_office_hours_long_duration_calls,
        "no_of_inbound_outside_office_hours_short_duration_calls":inbound_outside_office_hours_short_duration_calls,
        "no_of_inbound_outside_office_hours_long_duration_calls":inbound_outside_office_hours_long_duration_calls,
        "no_of_outbound_within_office_hours_short_duration_calls":outbound_within_office_hours_short_duration_calls,
        "no_of_outbound_within_office_hours_long_duration_calls":outbound_within_office_hours_long_duration_calls,
        "no_of_outbound_outside_office_hours_short_duration_calls":outbound_outside_office_hours_short_duration_calls,
        "no_of_outbound_outside_office_hours_long_duration_calls":outbound_outside_office_hours_long_duration_calls,
